    ...
    <>
      ...
      <NavLink className="navSepetIcon" to="/basket" variant="icon">
        ...
        {basketProductCount > 0 && (
          <span className="basketCount">{basketProductCount}</span>
        )}
      </NavLink>
    </>
  );
                ...
                {(popupState) => (
                  <React.Fragment>
                    ...
                    <Menu {...bindMenu(popupState)}>
                      <MenuItem onClick={() => navigate("/")}>All</MenuItem>
                      <MenuItem
                      ...
                      <MenuItem onClick={() => navigate("/category/jewelery")}>
                        Jewelry
                      </MenuItem>
                      <MenuItem
                        onClick={() => navigate("/basket")}
                        style={{ "border-top": "1px solid #18181c" }}
                      >
                        <LocalMallIcon /> Basket
                      </MenuItem>
                    </Menu>
                  </React.Fragment>
                )}
